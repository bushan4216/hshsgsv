...
<table class="frmLogin">
  ...
  <tr>
    ...
    <td align="center"><input name="username" type="text"  maxlength="50" title="Username Required!" class="textinput"/></td>
  </tr>
  <tr>
    <td align="right" style="font-size:12px;">&nbsp;&nbsp;&nbsp;Password :</td>
    <td align="center"><input name="password" type="password"  maxlength="50" title="Password Required!" class="textinput"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><input name="login" type="submit" value="   Login   "  class="btnAll"/>&nbsp;<input name="" type="button" value="   Close   " class="btnAll" onclick="window.close()"/></td>
  </tr>
</table>
