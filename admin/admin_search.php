...
while ($getValues = $frm->getArray($sqlView)) {
		echo "<tr>
				...
				<td width='40' class='td'><a href='index.php' OnClick=\"window.open('view.php?testID=".$getValues['exam_id']."','','width=800,height=850')\"><img src='".DIR."image/view.gif' title='View'/></a></td>
